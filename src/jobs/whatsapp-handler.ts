...
export function createHandler(
  ...
  return async (msg: WhatsAppMessage) => {
    ...
    try {
      ...
      const claudeResult = await claude.runClaude(prompt, scratchDir, { capability: "text-only", tier: "sonnet", agent: "plan", disallowedTools: claude.TEXT_ONLY_DISALLOWED_TOOLS });
