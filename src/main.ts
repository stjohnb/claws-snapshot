...
import * as stagingDbSync from "./jobs/staging-db-sync.js";
...
import { cancelCurrentTask, pruneAgentMcpDirs, pruneAgentOutputDir } from "./claude.js";
...
const jobs: Job[] = [
  ...
  {
    name: "staging-db-sync",
    intervalMs: 0,
    scheduledHour: SCHEDULES.stagingDbSyncHour,
    async run() {
      await stagingDbSync.run();
    },
  },
  {
    name: "github-status",
