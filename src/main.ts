...
function smartScheduledJob<T>(
  ...
  opts?: { skipWeekends?: boolean; postSummary?: (results: T[]) => void | Promise<void> },
): Job {
  return {
    name,
...
const jobs: Job[] = [
  ...
  smartScheduledJob("idea-suggester", ideaSuggester.processRepo, { skipWeekends: true, postSummary: ideaSuggester.postSummary }),
  {
    name: "idea-collector",
