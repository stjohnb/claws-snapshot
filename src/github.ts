...
import { z } from "zod";
import { GITHUB_OWNERS, isForgejoRepo, registerDiscoveredForgejoRepos, FORGEJO_REPOS, LABELS, LABEL_SPECS, SKIPPED_ITEMS, PRIORITIZED_ITEMS, ALLOWED_ACTORS, CI_FIXER_MAX_ATTEMPTS, CI_FIXER_WINDOW_MS, writeConfig, SELF_REPO, type Repo, type ConfigFile } from "./config.js";
