...
const { mockExecFile, mockListInstallationRepositories, mockIsForgejoRepo, mockRegisterDiscoveredForgejoRepos, mockIsRepoMonitored, mockForgejoRepos, mockForgejo } = vi.hoisted(() => ({
  mockExecFile: vi.fn(),
