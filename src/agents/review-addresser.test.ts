...
vi.mock("../github.js", () => ({ ...mockGh, ADDRESSED_REACTION: "rocket", REVIEW_ADDRESSED_MARKER: "review-addressed", REVIEW_REBUTTED_MARKER: "review-rebutted", ADVISORY_ADDRESSED_MARKER: "advisory-addressed" }));
