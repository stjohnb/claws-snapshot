 ...
 *  HA is configured and this is the HA config repo. Callers must pass the
 *  generated MCP config through provider selection and run options so whichever
 *  automated backend is selected receives the same tools. */
