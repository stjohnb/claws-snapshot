...
import { buildCapabilityEnvArgs, buildCapabilityPrompt, resolveCapabilityEnv } from "./capabilities.js";
...
function claudeShellArgs(sessionId: string, caps: string[], extra: string[]): string[] {
  ...
  return ["--dangerously-skip-permissions", ...promptArgs, ...uploadArgs, ...extra];
}
