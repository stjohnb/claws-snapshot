...
describe("selectStartupJobs", () => {
  ...
  it("registers exactly the issue/PR dispatcher and auto-merger lane when staging", () => {
...
describe("canRunJobForActivation", () => {
  ...
  it("allows only the issue/PR dispatcher and auto-merger lane in staging mode", () => {
    ...
    expect(canRunJobForActivation("auto-merger", "staging")).toBe(true);
