...
import { WORK_DIR, PROMPT_CAPTURE_DIR, CLAUDE_TIMEOUT_MS, CLAUDE_LIVENESS_TIMEOUT_MS, CLAUDE_WORKER_MEMORY_MAX_BYTES, SERVER_PORT, INTERNAL_MCP_TOKEN, NAMEY_DB_URL, HOME_ASSISTANT_BASE_URL, HOME_ASSISTANT_TOKEN, OPENROUTER_API_KEY, PROVIDER_RATE_LIMIT_COOLDOWN_MS, type Repo } from "./config.js";
 ...
 * failures (5xx responses and unexpected socket closures, across the Anthropic
 * and OpenCode/OpenAI backends).
 *
 * Two consumers share this single definition — keep them in mind when editing:
 ...
 */
export const API_TRANSIENT_RE = /API Error: 5\d\d|API Error: The socket connection was closed|openai\b.*\berror\b.*\b5\d\d\b/i;
