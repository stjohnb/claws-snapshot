 ...
 * filed its own alert issue for the failure (e.g. staging-db-sync's nightly
 * sync alert). reportError() recognizes it and skips filing a second
...
export async function reportError(
  ...
  // rethrowing (e.g. staging-db-sync). Filing a second [claws-error] issue
