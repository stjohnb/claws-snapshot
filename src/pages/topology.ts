...
const PIPELINE_NODES: TopoNode[] = [
  ...
  // Merger
  { id: "merger", label: "Merger", x: col(4), y: PR_MAIN_Y, agentJobs: ["auto-merger"], queueCategory: "auto-mergeable" },

  // Sink
  { id: "merged", label: "Merged", x: col(5), y: PR_MAIN_Y, virtual: true },
];
...
const PIPELINE_EDGES: TopoEdge[] = [
  ...
  // CI fix / review addressing feed forward to the merger
  { from: "ci-fixer",         to: "merger", label: "CI green",  toOffsetY: -8 },
  { from: "review-addresser", to: "merger", label: "Addressed", toOffsetY:  8 },
