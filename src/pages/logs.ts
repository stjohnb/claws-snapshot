...
import { PAGE_CSS, TAILWIND_STYLESHEET, HEAD_META, escapeHtml, formatDuration, htmlOpenTag, buildPageHeader, THEME_SCRIPT, LOCAL_TIME_SCRIPT, ALPINE_SCRIPT, timestampHtml } from "./layout.js";
import type { JobRun, JobLog, Task, TaskOutcome } from "../db.js";
import { isForgejoRepo, issueUrl } from "../config.js";
...
<body x-data="logsPage()">
  ...
  <div style="margin-bottom:1rem;font-size:0.85rem">
    <a href="${escapeHtml(encodeURI(issueUrl(repo, itemNumber)))}">View on ${isForgejoRepo(repo) ? "Forgejo" : "GitHub"}</a>
