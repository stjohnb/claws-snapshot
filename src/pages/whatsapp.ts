          ...
          <table class="data-cards">
            ...
            <tbody>
              <template x-for="ev in events" :key="ev.id">
                <tr>
                  <td data-label="Time" x-text="fmtTime(ev.occurred_at)"></td>
                  <td class="cell-title" data-label="Event">
                  ...
                  <td data-label="Detail" x-text="ev.detail || ''"></td>
                </tr>
              </template>
            </tbody>
          </table>
