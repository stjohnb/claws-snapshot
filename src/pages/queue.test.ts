...
describe("buildQueuePage refined button", () => {
  ...
  it("does not render refined-btn for issues already carrying the Refined label", () => {
  ...
  it("does not render refined-btn for needs-refinement issues already carrying the Refined label", () => {
