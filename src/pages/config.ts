...
import { PAGE_CSS, TAILWIND_STYLESHEET, escapeHtml, htmlOpenTag, buildPageHeader, THEME_SCRIPT, ALPINE_SCRIPT } from "./layout.js";
...
<body x-data="configPage()">
  ...
  <form method="POST" action="/config" class="config-form">
    ...
    <span class="field-note">Send Slack notifications for dashboard mutations (pause, skip, config changes, etc.)</span></div>
