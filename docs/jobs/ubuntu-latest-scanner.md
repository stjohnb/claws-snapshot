...
**Deep dive.** Read this when you're changing checks for billed GitHub-hosted
runners. For dynamic workflow runner detection, read
dynamic-workflow-runner-scanner.md instead.
