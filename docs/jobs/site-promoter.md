...
**Deep dive.** Read this when you're changing promotional-channel execution
for `docs/promotion/*.yaml`. For idea generation outside promotion manifests,
read idea-suggester.md instead.
