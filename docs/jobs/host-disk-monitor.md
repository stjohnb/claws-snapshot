...
3. `sweepTmp()` — three parts. The first two `find` passes cover the four named
   ...
   The final two passes are a generic sweep of the rest
...
line in the alert body pointing at it.
