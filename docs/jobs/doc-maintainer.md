...
source of truth lives in the separate `dot-files` repo (pr-2030, companion to
dot-files#248); a `docs/macos-runners.md` redirect stub was deliberately
removed rather than kept as a pointer. Only the claws-side mechanism —
