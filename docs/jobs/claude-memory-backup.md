...
**Deep dive.** Read this when you're changing memory backup to the
`claude-memories` branch. For how doc-maintainer consumes memories, read
doc-maintainer.md instead.
