...
**Deep dive.** Read this when you're changing scheduled reminder issue
creation. For general issue dispatch after a reminder files, read
...
The dedup key is backed by the [`reminder_notifications`](../database-schema.md#reminder_notifications-table) SQLite table.
