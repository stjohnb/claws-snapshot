...
**Deep dive.** Read this when you're changing the bstjohn-blog
Terraform/OpenTofu Dependabot unblocker. For general Dependabot alert handling,
read dependabot-alert-monitor.md instead.
