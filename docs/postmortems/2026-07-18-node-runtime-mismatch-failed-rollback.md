...
**Deep dive.** Read this when you're investigating the Node runtime mismatch
deploy incident or changing the release rollback safeguards. For the standard
incident template and process, read ../postmortem-process.md instead.
