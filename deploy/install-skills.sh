...
# ~/.claude/skills/ and ${CODEX_HOME:-~/.codex}/skills. Called by
# container-entrypoint.sh on every pod start; also runnable directly from
# a repo checkout.
#
...
# The image ships skills at deploy/skills (see the Dockerfile's COPY of .skills); a plain
